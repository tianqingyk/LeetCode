...
public class Question0317 {
     ...
     *
     * You want to build a house on an empty land that reaches all buildings in the shortest total travel distance. You
     ...
     */
    private void bfs2(int[][] grid, int[][][] distances, int row, int col) {
        int dirs[][] = {{1, 0}, {-1, 0}, {0, 1}, {0, -1}};
     ...
     * BEF from Houses to Empty Land(Optimized)
     */
